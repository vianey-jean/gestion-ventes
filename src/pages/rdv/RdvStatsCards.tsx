 ...
 * =============================================================================
 *
 * 5 cartes cliquables : Aujourd'hui, Cette semaine, Ce mois, En attente, Total du mois.
 */

import React from 'react';
import { Card, CardContent } from '@/components/ui/card';
import { Clock, TrendingUp, CalendarCheck, Crown, CalendarDays } from 'lucide-react';
...
interface RdvStatsCardsProps {
  ...
  weekCount: number;
  onOpenModal: (type: 'today' | 'week' | 'month' | 'pending' | 'total') => void;
}

const RdvStatsCards: React.FC<RdvStatsCardsProps> = ({ stats, currentMonthCount, weekCount, onOpenModal }) => {
  const cards = [
    ...
    { type: 'week' as const, label: 'Cette semaine', value: weekCount, delay: 0.15, colors: 'from-cyan-500/15 via-cyan-400/10 to-teal-600/5 border-cyan-300/50 dark:border-cyan-700/50', textColor: 'text-cyan-600/80 dark:text-cyan-400', gradientText: 'from-cyan-600 to-teal-700', iconBg: 'from-cyan-500 to-teal-600', iconShadow: 'shadow-cyan-500/30', icon: CalendarDays },
