    ...
    <div className="p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <Tabs defaultValue="ventes" onValueChange={setActiveTab} className="space-y-4 sm:space-y-6 md:space-y-8">
        ...
        <motion.div 
          ...
          className={cn(
            "relative bg-white/80 dark:bg-gray-800/80  rounded-2xl sm:rounded-3xl shadow-2xl p-3 sm:p-4 md:p-6 border border-white/30 dark:border-gray-700/30",
        ...
        <motion.div 
          ...
          className="relative bg-white/80 dark:bg-gray-800/80 rounded-2xl sm:rounded-3xl shadow-2xl border border-white/30 dark:border-gray-700/30 overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-gradient-to-bl from-purple-400/10 via-pink-400/5 to-transparent rounded-full pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-gradient-to-tr from-blue-400/10 via-cyan-400/5 to-transparent rounded-full pointer-events-none"></div>
