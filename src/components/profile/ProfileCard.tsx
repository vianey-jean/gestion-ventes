 ...
 * 
 * Affiche l'avatar (via ProfileAvatar), le nom complet, l'email,
 * le rôle utilisateur (badge), et le statut "En ligne" (pastille verte).
 * 
 * Utilisé dans ProfilePage (onglet Profil).
 * Cliquer sur l'avatar déclenche l'upload de photo.
 */
...
const ProfileCard: React.FC<ProfileCardProps> = ({
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
      className="relative rounded-3xl bg-white/70 dark:bg-white/5 border border-violet-200/30 dark:border-violet-800/20 shadow-2xl shadow-violet-500/5 overflow-hidden p-8"
    >
      ...
      <div className="flex flex-col items-center gap-6">
        {/* Avatar cliquable pour upload de photo */}
        ...
        <div className="text-center">
          ...
          {/* Badge du rôle (administrateur, admin principale, etc.) */}
          {userRole && (
          ...
          {/* Indicateur de statut "En ligne" avec pastille animée */}
          <div className="mt-2">
