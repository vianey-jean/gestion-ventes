...
const ObjectifIndicator: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/20">
      ...
      {/* Total Ventes */}
      <span className={`font-semibold text-xs sm:text-sm ${getProgressColor()}`}>
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="font-medium text-xs sm:text-sm text-primary hover:underline cursor-pointer flex items-center gap-0.5"
        >
