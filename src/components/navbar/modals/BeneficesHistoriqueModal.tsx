...
const BeneficesHistoriqueModal: React.FC<BeneficesHistoriqueModalProps> = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-lg bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-slate-950 dark:via-emerald-950/30 dark:to-slate-900 border-emerald-200/50 dark:border-emerald-800/50">
        ...
        <div className="space-y-4 pt-2">
          {/* Total Card */}
          <div className="p-4 rounded-2xl bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-300/50 dark:border-emerald-700/50">
