...
import { Eye, TrendingUp, Target, Sparkles, BarChart3, Calendar } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const StatCard: React.FC<StatCardProps> = ({ icon, label, value, gradient, shadowColor }) => (
  <div className={cn(
    "p-4 rounded-2xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-slate-200/50 dark:border-slate-700/50 shadow-xl transition-transform hover:scale-105",
