    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className={`max-w-2xl max-h-[80vh] overflow-y-auto
        bg-gradient-to-br ${isPositive ? 'from-white to-emerald-50/50 dark:from-gray-900 dark:to-emerald-950/30' : 'from-white to-red-50/50 dark:from-gray-900 dark:to-red-950/30'}
         border ${isPositive ? 'border-emerald-100/50 dark:border-emerald-800/30' : 'border-red-100/50 dark:border-red-800/30'}
        ...
        <div className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-4 bg-blue-50/80 dark:bg-blue-500/[0.08] border border-blue-200/60 dark:border-blue-500/20 rounded-xl text-center shadow-sm">
            ...
            <div className="p-4 bg-red-50/80 dark:bg-red-500/[0.08] border border-red-200/60 dark:border-red-500/20 rounded-xl text-center shadow-sm">
              <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <div className={`p-4 rounded-xl  text-center border shadow-sm ${isPositive
          ...
          <div className="border-t border-gray-200/60 dark:border-white/[0.06] pt-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between p-3 bg-indigo-50/80 dark:bg-indigo-500/[0.06] border border-indigo-200/50 dark:border-indigo-500/15 rounded-xl shadow-sm">
              ...
              <div className="flex justify-between p-3 bg-orange-50/80 dark:bg-orange-500/[0.06] border border-orange-200/50 dark:border-orange-500/15 rounded-xl shadow-sm">
