              ...
              <div className="relative flex flex-wrap justify-center gap-3 sm:gap-4">
                ...
                {onViewComments && (
                  <Button
                    ...
                    className={cn(
                      premiumBtnClass,
                      "overflow-visible relative bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-700 border-blue-300/40 text-white shadow-[0_20px_70px_rgba(59,130,246,0.5)]"
                    )}
                  >
                    <span className={mirrorShine} />
