...
// PUT change password — DÉSACTIVÉE : le changement de mot de passe nécessite
// désormais une double authentification (code à 6 chiffres). Voir :
//   POST /api/auth/change-password/request
//   POST /api/auth/change-password/verify
router.put('/password', authMiddleware, (req, res) => {
  res.status(410).json({
    message:
      "Cette route est désactivée. Utilisez /api/auth/change-password/request puis /api/auth/change-password/verify (double authentification requise).",
  });
});
