...
const validationSchemas = {
  ...
  // 2FA - Inscription en 2 temps (sans mot de passe à l'étape 1)
  registerStart: {
    email: { required: true, type: 'email' },
    firstName: { required: true, type: 'text', maxLength: 100 },
    lastName: { required: true, type: 'text', maxLength: 100 },
  ...
  registerComplete: {
    setupToken: { required: true, type: 'text', maxLength: 2000 },
    password: { required: true, type: 'password' },
    confirmPassword: { required: true, type: 'password' }
  },

  // 2FA - Vérification générique d'un code à 6 chiffres
  otpVerify: {
    challengeId: { required: true, type: 'text', maxLength: 100 },
    code: { required: true, type: 'text', maxLength: 6 }
  },
  ...
  resetPasswordWithToken: {
    resetToken: { required: true, type: 'text', maxLength: 2000 },
    newPassword: { required: true, type: 'password' },
    confirmPassword: { required: true, type: 'password' }
  },
  ...
  changePasswordVerify: {
    challengeId: { required: true, type: 'text', maxLength: 100 },
    code: { required: true, type: 'text', maxLength: 6 },
    currentPassword: { required: true, type: 'password' },
    newPassword: { required: true, type: 'password' },
    confirmPassword: { required: true, type: 'password' }
  },
